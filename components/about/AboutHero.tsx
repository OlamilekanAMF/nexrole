  ...
  return (
    <section className="relative min-h-[58vh] flex items-center justify-center text-center overflow-hidden py-20">
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10 space-y-6">
        ...
        >
          Connecting people with the <span className="italic text-gradient-gold">right opportunities.</span>
        </motion.h1>
        ...
        >
          NexRole helps employers find relevant professionals for genuine vacancies and helps candidates discover opportunities that fit their experience and career direction.
        </motion.p>
      </div>
    </section>
  );
